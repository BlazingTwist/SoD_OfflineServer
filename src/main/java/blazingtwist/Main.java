...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (false) {
			logger.info(MainDBAccessor.buildGUID("TestUser"));
			return;
		}

		if (false) {
			String input = "7Zmssi8dQ6sqtKWSkmXNPHPgD6lW3M8+NF+OEwNxQot4+VsoNBSa6uaPAHUDByRQBffADN5jEIxQZLLdMC+qOsDzGQkyjdHtddjIhJGc8YY=";
